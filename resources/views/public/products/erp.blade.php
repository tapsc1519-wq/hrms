...
@section('login-label','Open ERP')
@section('content')
<main>
<section class="hero"><div class="container hero-grid">
    <div class="hero-copy"><span class="kicker"><i class="bi bi-command"></i>Niyantron Enterprise ERP</span><h1>Source intelligently. Inspect dynamically. <span class="gradient-text">Trade with control.</span></h1><p>A company-aware ERP for new and pre-owned products, category-specific quality workflows, serialized inventory, CRM, finance and private B2B commerce.</p><div class="actions"><a class="btn btn-primary" href="https://erp.niyantron.com/login">Open Niyantron ERP <i class="bi bi-arrow-right"></i></a><a class="btn btn-secondary" href="/contact">Request an ERP walkthrough</a></div></div>
