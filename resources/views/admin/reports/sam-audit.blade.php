...
<div class="row g-3">
    ...
    <div class="col-xl-7"><div class="table-card h-100"><div class="card-header"><span class="fw-semibold">Package Contents</span></div><div class="table-responsive"><table class="table align-middle mb-0"><thead><tr><th class="ps-4">Evidence File</th><th>What It Proves</th></tr></thead><tbody>
        @foreach([
            ...
            ['Policy Exceptions','Time-bound approvals, expiry status, days to expiry, reasons, conditions, update timestamp and revocation history.'],
            ['Policy Exception Expiry','Expiring, expired, revoked, and recently updated exceptions with owner context and recommended governance action.'],
            ...
            ['Audit Metadata','Machine-readable package identifier, organization, filters, generator, timezone, and integrity settings.'],
            ['Audit Manifest','Evidence file list with byte size, CSV row count, SHA-256 hash, and generation timestamp for integrity checks.'],
