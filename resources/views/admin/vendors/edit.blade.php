...
<div class="page-header">
    <a href="{{ route('admin.suppliers.show', $vendor) }}" class="back-link"><i class="bi bi-arrow-left"></i> {{ $supplier->name }}</a>
    <h4>Edit Supplier</h4>
    <p>Update details for <strong>{{ $supplier->name }}</strong>.</p>
</div>

<form action="{{ route('admin.suppliers.update', $vendor) }}" method="POST" enctype="multipart/form-data">
@csrf @method('PUT')
<div class="row g-4">
...
<div class="form-actions" style="border-radius:14px;border:1px solid #e2e8f0;margin-top:.5rem">
    <a href="{{ route('admin.suppliers.show', $vendor) }}" class="btn-cancel">Cancel</a>
