...
<div class="page-header d-flex justify-content-between align-items-start">
    <div>
        <h4>Suppliers</h4>
        <p>{{ $vendors->total() }} vendor{{ $vendors->total() !== 1 ? 's' : '' }} registered</p>
    </div>
...
<div class="row g-3">
                ...
                <div class="d-flex align-items-start gap-3 mb-3">
                    ...
                    <div class="dropdown flex-shrink-0">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm" style="font-size:.875rem">
                            <li>
                                <a class="dropdown-item" href="{{ route('admin.suppliers.show', $vendor) }}">
                                    <i class="bi bi-eye me-2 text-primary"></i>View
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('admin.suppliers.edit', $vendor) }}">
                                    <i class="bi bi-pencil me-2 text-warning"></i>Edit
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <form action="{{ route('admin.suppliers.destroy', $vendor) }}" method="POST"
    ...
    <div class="col-12">
        <div class="table-card text-center py-5 text-muted">
            ...
            <small class="d-block mb-3">Add vendors to link them to assets, purchase orders, and invoices.</small>
